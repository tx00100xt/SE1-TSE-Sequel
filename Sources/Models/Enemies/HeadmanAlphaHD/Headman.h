...
#define HEADMAN_ATTACHMENT_NECK_STICK 5
#define HEADMAN_ATTACHMENT_BOMBER_HEAD 6
#define HEADMAN_ATTACHMENT_BOMBER_BAG 7
#define HEADMAN_ATTACHMENT_NECK_SAW 8
