...
//    if( m_iNukeBalls != 0) {m_strDescription.PrintF("%s: Nuke balls (%d)", (const char *) m_strDescription, m_iNukeBalls);}
    ...
    if( m_iPlasma != 0) {m_strDescription.PrintF("%s: Plasma (%d)", (const char *) m_strDescription, m_iPlasma);}
    if( m_iDev != 0) {m_strDescription.PrintF("%s: Devastator (%d)", (const char *) m_strDescription, m_iDev);}
  }
